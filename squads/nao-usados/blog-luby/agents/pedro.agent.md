---
id: "squads/blog-luby/agents/pedro"
name: "Pedro Revisor"
...
1. Ler `squads/blog-luby/output/article-brief.md` — title, instructions, max_words, publisher
2. Ler `squads/blog-luby/output/research-brief.md` — fontes verificadas e dados
3. Ler `squads/blog-luby/output/post-draft.md` — o HTML gerado pela Lara
