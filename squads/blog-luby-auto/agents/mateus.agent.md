---
id: "squads/blog-luby-auto/agents/mateus"
...
1. Ler `squads/blog-luby-auto/output/article-brief.md` — título, instructions, max_words, publisher (channel, name, language, flavor)
2. Ler `squads/blog-luby-auto/pipeline/data/sources.json` — lista de sites curados por idioma
